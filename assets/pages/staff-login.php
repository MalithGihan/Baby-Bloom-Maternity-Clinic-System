...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if ($stmt->num_rows === 1) {
        ...
        $stmt->bind_result($staffID,$staffFname,$staffMname,$staffSname,$staffAdd,$staffDOB,$staffNIC,$staffGender,$staffPhone,$staffPosition,$staffGetEmail,$staffGetPss,$staffRegDate);
        $stmt->fetch();
