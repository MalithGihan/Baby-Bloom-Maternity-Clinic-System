                ...
                <div class="status-data-container d-flex flex-column">
                    <div class="status-container staff-status-container flex-column" id="staff-container">
                        ...
                        <div class="" id="staff-stats-capture">
                            ...
                            <div class="stat-charts" id="staff-chart-container"></div>
                        </div>
                        <hr>
                            ...
                            <div class="d-flex flex-column">
                                <div class="d-flex moms-stat-row">
                                    <div class="moms-chart">
                                        ...
                                        <div class="stat-charts" id="mom-bg-chart-container"></div>
                                    </div>

                                    <div class="moms-chart">
                                        <h4 class="status-sub-title">Toxoid Vaccination Status</h4>
                                        <div class="stat-charts" id="mom-toxoid-chart-container"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex flex-column">
                                <div class="d-flex moms-stat-row">
                                    <div class="moms-chart">
                                        ...
                                        <div class="stat-charts" id="mom-rubella-chart-container"></div>
                                    </div>

                                    <div class="moms-chart">
                                        <h4 class="status-sub-title">RhoGAM Recommended Mothers</h4>
                                        <div class="stat-charts" id="mom-rgm-chart-container"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex flex-column">
                                <div class="d-flex moms-stat-row">
                                    <div class="moms-chart">
                                        ...
                                        <div class="stat-charts" id="supp-orders-chart-container"></div>
                                    </div>

                                    <div class="moms-chart">
                                        <h4 class="status-sub-title">Supplement delivery status</h4>
                                        <div class="stat-charts" id="supp-delivery-chart-container"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex flex-column">
                                <div class="d-flex moms-stat-row">
                                    <div class="moms-chart">
                                        ...
                                        <div class="stat-charts" id="today-apps-chart-container"></div>
                                    </div>

                                    <div class="moms-chart">
                                        <h4 class="status-sub-title">Monthly appointment status</h4>
                                        <div class="stat-charts" id="month-apps-chart-container"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
