    ...
    <div class="common-container d-flex">
        ...
        <main>
            <div class="main-header d-flex">
                <h2 class="main-header-title">"<?php echo $stFname; ?> <?php echo $stSname; ?>" PERSONAL DATA</h2>
            ...
            <div class="main-content d-flex flex-column">
                ...
                <form action="handlers/staff-update-handler.php?id=<?php echo urlencode($stID); ?>" method="POST" class="report-row flex-column" id="add-report-form">
            ...
            <div class="main-footer d-flex flex-row justify-content-between">
                <a href="../staff/staff-management.php">
