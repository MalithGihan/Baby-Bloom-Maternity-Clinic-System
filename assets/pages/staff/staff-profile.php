    ...
    <div class="common-container d-flex">
        ...
        <main>
            ...
            <div class="main-content d-flex flex-column">
                ...
                <form action="handlers/staff-update-handler.php" method="POST" class="report-row flex-column" id="add-report-form">
                ...
                <div class="data-row d-flex staff-account-container" id="password-reset">
                    ...
                    <form action="handlers/staff-pass-update-handler.php" method="POST" class="d-flex staff-repass">
