...
if ($result->num_rows === 0) {
    ...
    error_log("Unauthorized patient vaccination access attempt - NIC: $NIC, Staff: " . $_SESSION["staffEmail"]);
    ...
    <div class="common-container d-flex">
        ...
        <main>
            ...
            <div class="main-content d-flex flex-column">
                ...
                ?>
                <form action="handlers/vaccination-add-handler.php" method="POST" class="report-row flex-column" id="add-report-form">
