...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if ($stmt->num_rows === 1) {
        ...
        $stmt->bind_result($mamaNIC,$mamaRegDate,$mamaFname,$mamaMname,$mamaSname,$mamaBday,$mamaBplace,$mamaLRMP,$mamaAdd,$mamaPhone,$mamaHealthCond,$mamaAllergies,$mamaRubellaState,$mamaMstate,$mamaBloodRel,$mamaHubname,$mamaHubocc,$mamaHubPhone,$mamaHubDOB,$mamaHubBirthplace,$mamaHubHealthCond,$mamaHubAllergies,$mamaGetEmail,$mamaGetPss,$mamaProfilePic);
        $stmt->fetch();
